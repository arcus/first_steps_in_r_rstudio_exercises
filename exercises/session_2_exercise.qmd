...
**Note:** the "Solution" version of this file does not have additional material compared to this "Exercise" file.

**If you make changes to this file, please save it as `session_2_exercise_nn.qmd`, where "nn" are your initials. This is so you'll have your own copy with your changes, and you'll still have access to the original if you need it.**

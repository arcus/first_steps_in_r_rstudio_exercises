...
**If you make changes to this file, please save it as `session_4_exercise_nn.qmd`, where "nn" are your initials. This is so you'll have your own copy with your changes, and you'll still have access to the original if you need it.**
...
high_cholesterol_females_model_1 <-          |>
  select(-Age_Years)
View(        )
```
